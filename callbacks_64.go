...
func CBPrintRegisters(pid int, bp BreakPoint) {
	...
	fmt.Printf("%srax:%s 0x%012x (%d)%s\n", Blue, Green, uintptr(regs.Rax), uintptr(regs.Rax), Reset)
	fmt.Printf("%srbx:%s 0x%012x (%d)%s\n", Blue, Green, uintptr(regs.Rbx), uintptr(regs.Rbx), Reset)
	fmt.Printf("%srcx:%s 0x%012x (%d)%s\n", Blue, Green, uintptr(regs.Rcx), uintptr(regs.Rcx), Reset)
	fmt.Printf("%srdx:%s 0x%012x (%d)%s\n", Blue, Green, uintptr(regs.Rdx), uintptr(regs.Rdx), Reset)
	fmt.Printf("%srdi:%s 0x%012x (%d)%s\n", Blue, Green, uintptr(regs.Rdi), uintptr(regs.Rdi), Reset)
	fmt.Printf("%srsi:%s 0x%012x (%d)%s\n", Blue, Green, uintptr(regs.Rsi), uintptr(regs.Rsi), Reset)
	fmt.Printf("%srbp:%s 0x%012x (%d)%s\n", Blue, Green, uintptr(regs.Rbp), uintptr(regs.Rbp), Reset)
	fmt.Printf("%srsp:%s 0x%012x (%d)%s\n", Blue, Green, uintptr(regs.Rsp), uintptr(regs.Rsp), Reset)
	fmt.Printf("%srip:%s 0x%012x (%d)%s\n", Blue, Green, uintptr(regs.Rip), uintptr(regs.Rip), Reset)
	/*
